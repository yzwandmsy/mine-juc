...
import com.it.policy.DefaultPolicyHandler;
import com.it.policy.PolicyHandler;
 ...
 * @description :
 */
public class TulingThreadPoolExecutor implements TuLingExecutorService {
    /**
     * 默认队列大小
     */
    ...
    public TulingThreadPoolExecutor(){
        this(defaultPoolSize,defaultQueueSize,defaultAliveTime,new DefaultPolicyHandler());
    }

    public TulingThreadPoolExecutor(int poolsize){
        this(poolsize,defaultQueueSize,defaultAliveTime,new DefaultPolicyHandler());
    }

    public TulingThreadPoolExecutor(int poolsize,int queueSize,long keepAliveTime,PolicyHandler handler){
